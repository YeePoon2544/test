...
var KTBootstrapDaterangepicker = function () {
    ...
    var demos = function () {
        ...
        // date & time
        $('#kt_daterangepicker_4_1').daterangepicker({
            buttonClasses: ' btn',
            applyClass: 'btn-primary',
            cancelClass: 'btn-secondary',
            ...
            $('#kt_daterangepicker_4_1 .form-control').val( start.format('DD-MM-YYYY h:mm A') + ' / ' + end.format('DD-MM-YYYY h:mm A'));
        });

        $('#kt_daterangepicker_4_2').daterangepicker({
            buttonClasses: ' btn',
            applyClass: 'btn-primary',
            cancelClass: 'btn-secondary',
            ...
            $('#kt_daterangepicker_4_2 .form-control').val( start.format('MM/DD/YYYY h:mm A') + ' / ' + end.format('MM/DD/YYYY h:mm A'));
        });
