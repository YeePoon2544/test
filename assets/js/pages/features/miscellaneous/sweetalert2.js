...
var KTSweetAlert2Demo = function () {
	var _init = function () {
		...
		// $('#kt_sweetalert_delete_health').click(function (e) {
		...
		// 	}).then(function (result) {
		// 		if (result.value) {
		// 			window.location.href="index.php?menu=DelHealth&id_del_no="+id_del_no;
		// 			Swal.fire(
		// 				'Deleted!',
		// 				'Your file has been deleted.',
		// 				'success'
		...
		$('#ClickImageSize').click(function (e) {
			Swal.fire({
				imageUrl: 'fileupload/train/head/pop.jpg',
  				width: 600,
  				height: 400,
